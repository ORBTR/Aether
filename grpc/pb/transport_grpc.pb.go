...
const (
	TransportService_Stream_FullMethodName = "/aether.grpc.v1.TransportService/Stream"
	TransportService_Ping_FullMethodName   = "/aether.grpc.v1.TransportService/Ping"
)
...
var TransportService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "aether.grpc.v1.TransportService",
